...
public class WaterCrystalStructures extends StructureFeature<JigsawConfiguration> {

    public WaterCrystalStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, WaterCrystalStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
